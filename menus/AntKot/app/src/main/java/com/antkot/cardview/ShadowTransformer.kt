...
class ShadowTransformer(private val mViewPager: ViewPager, private val mAdapter: CardAdapter) : ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
    ...
    override fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) {
        ...
        if (currentCard != null) {
            ...
            currentCard.cardElevation = baseElevation + baseElevation * (CardAdapter.MAX_ELEVATION_FACTOR - 1).toFloat() * (1 - realOffset)
        }
        ...
        if (nextCard != null) {
            ...
            nextCard.cardElevation = baseElevation + baseElevation * (CardAdapter.MAX_ELEVATION_FACTOR - 1).toFloat() * realOffset
        }
